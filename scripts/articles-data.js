...
window.GUMI_ARTICLES = {
    'ardacraft-social': {
        cover: '/media/ardacraft-social-featured-image.webp',
        coverAlt: 'Abonnés Instagram d’ArdaCraft, de 9 877 en janvier 2024 à 115 579 en août',
        readNext: 'ardacraft',
        published: '2026-07-29',
        title: {
            fr: 'Emprunter les codes du voyage pour filmer la Terre du Milieu : 27 millions de vues en sept mois',
            en: 'Borrowing travel-reel grammar to film Middle-earth: 27 million views in seven months'
        },
        excerpt: {
            fr: 'Je voulais m’entraîner à faire des vidéos. En filmant les décors d’ArdaCraft comme des paysages, avec les codes des Reels de voyage, 24 vidéos ont cumulé 27,3 millions de vues.',
            en: 'I wanted to practise making videos. By filming ArdaCraft’s builds like landscapes, borrowing the grammar of travel Reels, 24 videos gathered 27.3 million views.'
        },
        // Lifted out of the body: it renders above the cover and the table of
        // contents, so a reader who stops at the top still gets the story.
        abstract: {
            fr: `<div class="abstract">
                <h2>Si vous n’avez pas le temps de tout lire</h2>
                <p>Au départ, je voulais simplement m’entraîner à faire des vidéos. ArdaCraft comptait <strong>9 877 abonnés</strong> sur Instagram et les vidéos publiées jusque-là dépassaient rarement les 30 000 vues. Je me suis dit que c’était un bon terrain pour tester une idée : filmer les décors de la communauté comme des paysages, en reprenant quelques codes des Reels de voyage.</p>
                <p>Le premier Reel a obtenu <strong>465 000 vues</strong>. Je ne m’y attendais pas du tout, alors j’ai continué pour voir si je pouvais le refaire.</p>
                <p>J’ai finalement réalisé 24 vidéos, seul, sur mon temps libre et sans budget publicitaire. Elles ont cumulé <strong>27,3 millions de vues</strong>, avec une médiane de 342 000. Vingt-deux ont dépassé les 30 000 vues et le compte est passé de 9 877 à plus de 100 000 abonnés pendant le premier sprint de publication.</p>
            </div>`,
            en: `<div class="abstract">
                <h2>If you do not have time to read it all</h2>
                <p>At the start, I simply wanted to practise making videos. ArdaCraft had <strong>9,877 followers</strong> on Instagram and the videos published until then rarely passed 30,000 views. It struck me as good ground to test an idea: filming the community’s builds like landscapes, borrowing a few conventions from travel Reels.</p>
                <p>The first Reel reached <strong>465,000 views</strong>. I had not expected that at all, so I kept going to see whether I could do it again.</p>
                <p>I ended up making 24 videos, on my own, in my spare time and with no ad budget. They gathered <strong>27.3 million views</strong>, with a median of 342,000. Twenty-two passed 30,000 views and the account went from 9,877 to more than 100,000 followers during the first publishing sprint.</p>
            </div>`
        },
        html: {
            fr: `<h2>Au départ, je voulais juste m’entraîner</h2>
<p>ArdaCraft recrée la Terre du Milieu dans Minecraft depuis 2014. La communauté a déjà construit plus de 300 lieux à l’échelle 1:58, avec derrière chacun d’eux des recherches en géologie, en botanique ou encore en histoire.</p>
<p>Quand j’ai commencé à filmer pour le projet, je n’avais pas pour objectif de faire gagner 100 000 abonnés au compte. J’avais surtout envie de progresser en vidéo et, avec plus de 300 lieux déjà construits, je ne manquais pas vraiment de sujets.</p>
<p>À ce moment-là, le compte Instagram comptait 9 877 abonnés. Les vidéos publiées avant mon arrivée tournaient généralement autour de 30 000 vues, souvent moins.</p>
<p>30 000 vues, ce n’était pas mauvais. Mais quand je voyais tout ce que la communauté avait construit depuis 2014, je me disais qu’on pouvait clairement faire mieux.</p>
<p>Je n’avais pas vraiment de plan à long terme. J’avais une idée et l’envie de voir ce qu’elle pouvait donner.</p>
<h2>Filmer Minecraft comme une destination</h2>
<p>Mon premier réflexe aurait pu être de regarder ce qui fonctionnait sur les autres comptes Minecraft. J’ai fait l’inverse : je suis allé voir du côté des vidéos de voyage.</p>
<p>En fait, ce n’était pas si étrange. ArdaCraft est construit dans Minecraft, mais ce que je filmais, c’étaient des paysages, des villes, des fermes, des montagnes ou des tours de garde. Les créateurs de voyage avaient déjà trouvé beaucoup de façons de donner envie de découvrir un lieu.</p>
<p>J’ai commencé par reprendre deux principes assez simples.</p>
<p>Le premier concernait l’ordre des plans. Le meilleur devait passer en premier. Sur Instagram, le spectateur décide très vite s’il reste ou s’il continue de faire défiler. Garder mon plus beau plan pour la fin ne servait donc pas à grand-chose si personne ne la regardait.</p>
<p>Le second concernait le son. Je choisissais la musique avant de commencer le montage, puis je construisais la vidéo autour d’elle. Le rythme des coupes, les mouvements de caméra et la durée des plans venaient ensuite se caler dessus.</p>
<p>Deux règles, ça tient en quelques lignes. Le reste est beaucoup plus difficile à expliquer.</p>
<p>Il y avait le lieu choisi, l’heure à laquelle je le filmais, la lumière, l’angle de départ, la vitesse de la caméra, le moment exact où je coupais un plan ou celui où la musique changeait. Aucune de ces décisions ne suffisait à faire une bonne vidéo, mais il suffisait parfois d’en rater une pour que l’ensemble fonctionne moins bien.</p>
<p>Je faisais encore une bonne partie de ces choix au ressenti. C’était justement pour ça que je m’entraînais.</p>
<h2>465 000 vues au premier essai</h2>
<p>J’ai publié le premier Reel au mois de février.</p>
<p>Au bout d’un ou deux jours, il avait déjà largement dépassé mes attentes. Il a fini par atteindre 465 000 vues.</p>
<p>Je ne m’y attendais pas du tout. Les membres d’ArdaCraft étaient hyper contents et reconnaissants. Moi, je me demandais surtout si je pouvais le refaire.</p>
<p>Une seule vidéo ne prouvait pas grand-chose. J’en ai donc fait une deuxième. Puis une troisième.</p>
<ul class="reel-list"><li><a class="reel-card" href="https://www.instagram.com/reel/C3muxgyMVww/" rel="noopener" target="_blank"><span class="reel-play" aria-hidden="true"></span><span>Reel 1</span></a><p class="reel-caption">À observer : le tout premier plan. C’est le meilleur de la vidéo, jamais celui que je gardais pour la fin.</p></li><li><a class="reel-card" href="https://www.instagram.com/reel/C52nt43Ms2K/" rel="noopener" target="_blank"><span class="reel-play" aria-hidden="true"></span><span>Reel 2</span></a><p class="reel-caption">À écouter : la musique. Elle est choisie avant le montage, et le rythme des coupes vient se caler dessus.</p></li><li><a class="reel-card" href="https://www.instagram.com/reel/C7RRKiVsEzC/" rel="noopener" target="_blank"><span class="reel-play" aria-hidden="true"></span><span>Reel 3</span></a><p class="reel-caption">À observer : le cadrage. Le lieu est filmé comme un paysage à visiter, pas comme une construction.</p></li></ul>
<h2>Est-ce que je pouvais le refaire ?</h2>
<p>Entre février et mai, j’ai enchaîné un premier sprint de production. Je publiais environ une vidéo par semaine au début. Je les réalisais seul, sur mon temps libre.</p>
<p>Selon les lieux et le montage, une vidéo me demandait entre deux et cinq heures. Je cherchais les références, choisissais le lieu, préparais les plans, faisais la captation, trouvais la musique et montais l’ensemble.</p>
<p>Je regardais les performances, bien sûr, mais l’analyse restait assez simple. Je passais surtout mon temps à fabriquer la vidéo suivante et à ajuster ce qui me semblait pouvoir être amélioré.</p>
<p>Toutes n’ont pas connu le même succès. Si je prends la moyenne, j’arrive à 1,1 million de vues par vidéo. C’est tentant de s’arrêter à ce chiffre, mais trois vidéos concentrent à elles seules 17,4 millions de vues, soit 64 % du total.</p>
<p>Le chiffre que je trouve plus intéressant, c’est que 22 vidéos sur 24 ont dépassé les 30 000 vues qui constituaient jusque-là le niveau habituel du compte. La médiane s’établit à 342 000 vues.</p>
<p>Après 24 vidéos, j’avais ma réponse : je pouvais le refaire.</p>
<h2>Vingt-quatre vidéos plus tard</h2>
<p>Entre la mi-février et la fin du mois de septembre, j’ai réalisé 24 vidéos. Elles ont cumulé 27,3 millions de vues. Le tout sans budget publicitaire, avec une diffusion entièrement organique.</p>
<p>C’est aussi pendant le premier sprint, lorsque je publiais le plus régulièrement, que le compte a gagné la majorité de ses nouveaux abonnés. ArdaCraft est passé de 9 877 abonnés fin janvier à 102 748 fin mai.</p>
<p>À la fin du mois d’août, le compte en comptait 115 579. Près de 88 % des abonnés gagnés sur la période étaient donc arrivés avant la fin du mois de mai.</p>
<table><thead><tr><th>Fin de mois</th><th>Abonnés</th><th>Gain</th></tr></thead><tbody><tr><td>janvier 2024</td><td>9 877</td><td></td></tr><tr><td>février</td><td>27 506</td><td>+17 629</td></tr><tr><td>mars</td><td>63 001</td><td>+35 495</td></tr><tr><td>avril</td><td>82 258</td><td>+19 257</td></tr><tr><td>mai</td><td>102 748</td><td>+20 490</td></tr><tr><td>juin</td><td>108 675</td><td>+5 927</td></tr><tr><td>juillet</td><td>113 852</td><td>+5 177</td></tr><tr><td>août</td><td>115 579</td><td>+1 727</td></tr></tbody></table>
<h2>Après le premier sprint</h2>
<p>À partir de mai, j’ai commencé à publier moins régulièrement.</p>
<p>Ce n’était pas parce que le format avait cessé de fonctionner. J’étais venu pour m’entraîner et tester une idée. J’avais testé, ça avait marché, et j’avais réussi à le reproduire. J’avais donc terminé ce pour quoi j’étais venu.</p>
<p>D’autres membres ont continué à alimenter le compte. Moi, je ne publiais plus que ponctuellement. La croissance a commencé à ralentir au même moment, comme le montre assez clairement le tableau.</p>
<p>J’ai encore produit quelques vidéos jusqu’à la fin du mois de septembre, mais je regardais déjà ailleurs.</p>
<h2>Le problème suivant</h2>
<p>À ce moment-là, c’est le site d’ArdaCraft qui a commencé à m’intéresser. Les vidéos y envoyaient désormais beaucoup plus de monde, mais une fois sur le site, on ne savait pas vraiment par où commencer ni quoi aller voir.</p>
<p>J’avais envie de comprendre comment mieux accueillir cette nouvelle audience et lui permettre d’explorer le travail de la communauté.</p>
<p>C’est comme ça que je suis passé des vidéos à la <a href="ardacraft">refonte du site</a>, puis à la création d’une <a href="ardacraft-map">carte interactive</a> inspirée de Google Maps.</p>
<p>Je ne savais pas encore que ce nouveau problème allait m’occuper pendant près de 150 heures. Mais ça, c’est l’expérience suivante.</p>`,
            en: `<p class="lang-note"><strong>This study is in French.</strong> The summary above covers it; the article itself is below, in French.</p><h2>Au départ, je voulais juste m’entraîner</h2>
<p>ArdaCraft recrée la Terre du Milieu dans Minecraft depuis 2014. La communauté a déjà construit plus de 300 lieux à l’échelle 1:58, avec derrière chacun d’eux des recherches en géologie, en botanique ou encore en histoire.</p>
<p>Quand j’ai commencé à filmer pour le projet, je n’avais pas pour objectif de faire gagner 100 000 abonnés au compte. J’avais surtout envie de progresser en vidéo et, avec plus de 300 lieux déjà construits, je ne manquais pas vraiment de sujets.</p>
<p>À ce moment-là, le compte Instagram comptait 9 877 abonnés. Les vidéos publiées avant mon arrivée tournaient généralement autour de 30 000 vues, souvent moins.</p>
<p>30 000 vues, ce n’était pas mauvais. Mais quand je voyais tout ce que la communauté avait construit depuis 2014, je me disais qu’on pouvait clairement faire mieux.</p>
...
<p>Je ne m’y attendais pas du tout. Les membres d’ArdaCraft étaient hyper contents et reconnaissants. Moi, je me demandais surtout si je pouvais le refaire.</p>
<p>Une seule vidéo ne prouvait pas grand-chose. J’en ai donc fait une deuxième. Puis une troisième.</p>
<ul class="reel-list"><li><a class="reel-card" href="https://www.instagram.com/reel/C3muxgyMVww/" rel="noopener" target="_blank"><span class="reel-play" aria-hidden="true"></span><span>Reel 1</span></a><p class="reel-caption">What to watch: the opening shot. It is the best one in the video, never the one I saved for the end.</p></li><li><a class="reel-card" href="https://www.instagram.com/reel/C52nt43Ms2K/" rel="noopener" target="_blank"><span class="reel-play" aria-hidden="true"></span><span>Reel 2</span></a><p class="reel-caption">What to listen for: the music. It was picked before the edit, and the cuts fall in behind it.</p></li><li><a class="reel-card" href="https://www.instagram.com/reel/C7RRKiVsEzC/" rel="noopener" target="_blank"><span class="reel-play" aria-hidden="true"></span><span>Reel 3</span></a><p class="reel-caption">What to watch: the framing. The place is filmed like a landscape to visit, not like a build.</p></li></ul>
<h2>Est-ce que je pouvais le refaire ?</h2>
<p>Entre février et mai, j’ai enchaîné un premier sprint de production. Je publiais environ une vidéo par semaine au début. Je les réalisais seul, sur mon temps libre.</p>
<p>Selon les lieux et le montage, une vidéo me demandait entre deux et cinq heures. Je cherchais les références, choisissais le lieu, préparais les plans, faisais la captation, trouvais la musique et montais l’ensemble.</p>
<p>Je regardais les performances, bien sûr, mais l’analyse restait assez simple. Je passais surtout mon temps à fabriquer la vidéo suivante et à ajuster ce qui me semblait pouvoir être amélioré.</p>
...
<p>Je ne savais pas encore que ce nouveau problème allait m’occuper pendant près de 150 heures. Mais ça, c’est l’expérience suivante.</p>`
    ...
    'ardacraft': {
        ...
        html: {
            ...
            <p>En 2024, j'ai produit 24 vidéos pour le compte Instagram du projet. Elles ont cumulé 27,3 millions de vues et fait passer le compte de 9 877 à plus de 115 000 abonnés, une série que je raconte dans <a href="ardacraft-social">une étude à part</a>. Le nombre de visiteurs sur le site, lui, ne décollait pas. J'ai vite compris le problème. Notre site web était un goulot d'étranglement. Pour un utilisateur curieux, comprendre comment commencer la visite du monde relevait du parcours du combattant.</p>
            ...
            <figure class="image-breakout">
                ...
                <figcaption>L'ampleur du projet : quelques-uns des plus de 300 lieux recréés bloc par bloc par la communauté.</figcaption>
            </figure>

            <h2>La rançon du succès</h2>
            ...
            <p>Ce chantier de refonte et de migration m'a demandé <strong>bien 150 heures de travail étalées sur 3 mois</strong>. J'ai été le contributeur principal sur cette partie, avec des coups de main réguliers du reste de l'équipe.</p>
            ...
            <p>Mon maître-mot était l'<strong>immersion</strong>. Le risque, avec des partis pris visuels aussi marqués, est de dégrader la navigation. La réponse a tenu dans la subtilité. Des images en fond, des dégradés, du <em>glassmorphism</em> avec parcimonie, et beaucoup moins d'éléments visibles à l'écran.</p>
            ...
            <p>S'il est presque impossible de mesurer l'impact réel d'un nouveau design sur un projet associatif comme le nôtre, le gain est ailleurs : nous disposons enfin d'une belle cohérence visuelle sur l'intégralité des pages, et le site agit désormais comme un pilier fort de l'identité de marque d'ArdaCraft.</p>

            <hr />

            <h2>2. L'efficacité du parcours</h2>
            <p>Pour optimiser le parcours, je me suis appuyé sur <a href="https://clarity.microsoft.com/" target="_blank" rel="noopener">Microsoft Clarity</a>, un outil d'analyse UX qui permet de visualiser le comportement des utilisateurs (via des cartes de chaleur ou des enregistrements de sessions). Le constat a été simple : la plupart des éléments coupés par le bas de l'écran n'étaient jamais utilisés. J'ai donc remonté ces fonctionnalités clés en haut de page pour les rendre immédiatement accessibles.</p>
            ...
            <p>Nous continuons à suivre ces chiffres et à ajuster la page.</p>

            <hr />

            <h2>3. L'adaptabilité</h2>
            ...
            <p>ArdaCraft est un projet qui se base sur des recherches approfondies touchant à la géologie, la botanique, l'histoire et leurs influences sur le monde de Tolkien. Notre carte regroupe ces éléments scientifiques et narratifs pour les mettre à la disposition des passionnés. Elle a fait l'objet d'<a href="ardacraft-map">une étude séparée</a>.</p>
            <p>Je travaille maintenant sur la V3 de cette carte.</p>
            `,
            en: `
            <div class="abstract">
            ...
            <p>In 2024 I produced 24 videos for the project's Instagram account. They gathered 27.3 million views and took the account from 9,877 to more than 115,000 followers, a run I cover in <a href="ardacraft-social">a separate study</a>. The number of visitors to the site, though, was not taking off. I quickly understood the problem. Our website was a bottleneck. For a curious user, figuring out how to start exploring the world was an obstacle course.</p>
            ...
            <figure class="image-breakout">
                ...
                <figcaption>The scale of the project: a few of the more than 300 locations recreated block by block by the community.</figcaption>
            </figure>
    ...
    'ardacraft-map': {
        ...
        html: {
            ...
            <h2>L'opportunité</h2>
            <p>Je produisais depuis un an les vidéos du projet, <a href="ardacraft-social">27,3 millions de vues sur 24 publications</a>, puis j'avais <a href="ardacraft">repris le site</a> pour que ce trafic arrive quelque part. Restait une audience que les réseaux sociaux ne touchaient pas. Je me suis donc penché sur notre stratégie SEO. C'est en analysant le marché autour de l'univers de Tolkien qu'un segment précis a immédiatement capté mon attention : les recherches de cartes. Les données Semrush montraient un écosystème de <strong>plus d'un million de recherches par an</strong> en incluant toutes les variantes du mot-clé « middle earth map ».</p>
            ...
            <p>C'est pour offrir cette expérience supérieure que j'ai pris la décision de lancer notre propre <a href="https://ardacraft.me/map/middle-earth-interactive-map" target="_blank" rel="noopener">carte interactive de la Terre du Milieu</a>. Voici comment nous avons transformé ces données de recherche et nos forces communautaires en un projet concret, conçu dès le premier jour pour se positionner sur ces requêtes.</p>

            <hr />

            <h2>L'analyse de la SERP</h2>
            ...
            <h2>La V2, mobile et gamification</h2>
            ...
            <p>L'analyse de ces chiffres est pleine d'enseignements. Le potentiel est réel. On frôle les 200 000 impressions mensuelles très rapidement. Mais avoir dû couper le site à la moitié du mois en janvier et en mars, pour préserver notre budget, nous a sans doute coûté cher en référencement. Google n'aime pas l'instabilité, et ces coupures ont freiné notre dynamique de croissance.</p>

            <h3>La preuve par le trafic « hors-marque »</h3>
            <p>Malgré ces perturbations techniques, l'impact stratégique est incontestable. Depuis février, la Google Search Console permet d'isoler très facilement les requêtes « non-brandées » (les recherches qui ne contiennent pas le nom d'ArdaCraft). <strong>La carte représente à elle seule 50 % de notre trafic hors-marque.</strong></p>
            ...
            <h2>Objectif V3</h2>
            <p>La <a href="ardacraft">migration vers notre architecture décentralisée</a> (WordPress, GraphQL, Cloudflare, Webstudio) nous offre enfin un système fiable et financièrement viable. Fini l'épée de Damoclès des surcoûts liés au volume de trafic.</p>
            ...
            <p>Aujourd'hui la base technique est robuste et le contenu complet. Une fois cette V3 déployée, nos efforts basculeront sur le dernier pilier essentiel de notre stratégie d'acquisition : le <strong>netlinking</strong>. Nous concentrerons nos efforts sur une grande campagne de communication entièrement axée sur la valeur unique de cet outil, afin d'aller chercher les backlinks nécessaires pour installer durablement ArdaCraft sur ces requêtes.</p>
            `,
            en: `
            <div class="abstract">
            ...
            <p>In my constant search for new opportunities to grow <strong>ArdaCraft</strong>, I decided to take our SEO strategy seriously. While analyzing the market around Tolkien's universe, one specific segment immediately caught my attention: map searches. The Semrush data showed an ecosystem of <strong>more than one million searches per year</strong> when including every variant of the keyword "middle earth map".</p>
            ...
            <p>That's when the connection with ArdaCraft became obvious. We had assets the other maps did not. Precise geographic data (biomes, regions, coordinates from our Minecraft map), thousands of unique photos to concretely illustrate each location, and above all a community of enthusiasts who know Tolkien's texts inside out to guarantee absolute accuracy.</p>
            <p>To offer that superior experience, I decided to launch our own <a href="https://ardacraft.me/map/middle-earth-interactive-map" target="_blank" rel="noopener">interactive map of Middle-earth</a>. Here's how we turned that search data and our community strengths into a concrete project, designed from day one to rank on those queries.</p>
            ...
            <p>My product strategy was therefore to gather in one tool the features scattered across the others, and add ours. For the interface (UI) and usability (UX), I chose not to reinvent the wheel. I based everything on the universal standards of <strong>Google Maps</strong>, a tool everyone already knows how to use, to offer immediately smooth and intuitive navigation.</p>
            ...
            <h2>V2, mobile and gamification</h2>
            ...
            <p>Today the technical foundation is robust and the content complete. Once V3 is deployed, our efforts will shift to the last essential pillar of our acquisition strategy: <strong>link building</strong>. We'll focus on a large communication campaign built entirely around the unique value of this tool, to earn the backlinks needed to durably establish ArdaCraft on those queries.</p>
            `
        }
    },
