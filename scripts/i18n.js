(function () {
    const DICT = {
        ...
        bg_s6_intro: { fr: "Lucide, trait de 2,5 px, extrémités et angles arrondis.", en: "Lucide, 2.5px stroke, rounded caps and joins." },
        bg_s6_h1: { fr: "L'icône en halftone", en: "The halftone icon" },
        bg_s6_h1_texte: { fr: "Le tracé lui-même est tramé, jamais une plaque posée derrière. Trame de 9,5 px sur un carré de 400, soit 42 rangées : le point grossit là où le dessin est plein et se referme là où il s'amincit, et les points fusionnent en aplat au cœur des traits épais. Les fichiers sont noirs sur transparent et servent de masque, donc ils prennent l'encre de la page dans les deux thèmes. À réserver aux grands formats, à partir de 200 px de côté : en dessous, la trame passe sous les 5 px à l’écran et l’icône redevient un aplat.", en: "The stroke itself is screened, never a plate laid behind it. A 9.5px screen on a 400px square, so 42 rows: the dot grows where the drawing is solid and closes where it thins, and the dots merge into a flat area at the heart of thick strokes. The files are black on transparent and serve as a mask, so they take the page’s ink in both themes. Keep them for large formats, from 200px across: below that the screen drops under 5px on screen and the icon becomes a flat shape again." },
