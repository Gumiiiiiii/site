(function () {
    const DICT = {
        ...
        cv_hero_sub: { fr: "J’aide les marques à mieux présenter, vendre et faire découvrir leurs produits en ligne. J’aime les sujets où contenu, donnée produit, acquisition et expérience utilisateur se rencontrent, et où il faut autant réfléchir que faire.", en: "I help brands present, sell and get their products discovered online. I enjoy working where content, product data, acquisition and user experience meet, especially when a project calls for both strategic thinking and hands-on delivery." },
        cv_cta_write: { fr: "Me contacter", en: "Contact me" },
        cv_cta_book: { fr: "Réserver 20 min", en: "Book 20 minutes" },
        cv_cta_pdf: { fr: "CV PDF (1 page)", en: "One-page CV" },
        cv_avail: { fr: "Disponible en septembre 2026 · CDI · France, Belgique, Suisse, Luxembourg · sur site ou remote", en: "Available from September 2026 · Full-time permanent position · France, Belgium, Switzerland or Luxembourg · on-site or remote" },
        cv_photo_alt: { fr: "Portrait de Pierre Gumilar", en: "Portrait of Pierre Gumilar" },
        cv_sec_results: { fr: "Résultats clés", en: "Key results" },
        cv_kpi1_num: { fr: "<span class=\"cv-from\">500 →</span> 5 000", en: "<span class=\"cv-from\">500 →</span> 5,000" },
        cv_kpi1_label: { fr: "Fiches produits enrichies", en: "Enriched product records" },
        cv_kpi1_src: { fr: "Magento · Salsify", en: "Magento · Salsify" },
        cv_kpi2_num: { fr: "+180 %", en: "+180%" },
        cv_kpi2_label: { fr: "Trafic organique de lindt.fr", en: "Organic traffic on lindt.fr" },
        cv_kpi2_src: { fr: "Fin 2023 – mi-2026", en: "Late 2023 – mid-2026" },
        cv_kpi3_num: { fr: "500+", en: "500+" },
        cv_kpi3_label: { fr: "Réservations attribuées à Google Ads", en: "Bookings attributed to Google Ads" },
        cv_kpi3_src: { fr: "Émeraude Aventure · deux mois", en: "Emeraude Aventure · two months" },
        cv_kpi4_num: { fr: "7 000+", en: "7,000+" },
        cv_kpi4_label: { fr: "Assets e-commerce coordonnés", en: "E-commerce assets coordinated" },
        cv_kpi4_src: { fr: "Production · validation · diffusion", en: "Production · approval · distribution" },
        cv_sec_work: { fr: "Quelques projets et leurs résultats", en: "Selected projects and their results" },
        cv_sec_work_intro: { fr: "Voici trois projets qui représentent bien ma façon de travailler : comprendre ce qui bloque, construire une réponse concrète et regarder honnêtement ce qu’elle produit.", en: "These three projects capture how I like to work: understand what is getting in the way, build a practical solution and look honestly at the impact." },
        cv_work1_label: { fr: "Lindt & Sprüngli · CDI · 2023 – août 2026", en: "Lindt & Sprüngli · full-time role · 2023 – August 2026" },
        cv_work1_title: { fr: "Faire grandir le contenu e-commerce sans perdre en cohérence", en: "Scaling e-commerce content without losing consistency" },
        cv_work1_p1: { fr: "Chez Lindt, je fais le lien entre la donnée produit, les contenus et leur diffusion en ligne. Je structure le catalogue et le PIM Salsify, coordonne les contenus pour Amazon et les e-retailers, et pilote les shootings ainsi que la direction artistique.", en: "At Lindt, I connect product data, content and online distribution. I structure the catalogue and Salsify PIM, coordinate Amazon and e-retail content, and lead photoshoots and art direction." },
        cv_work1_p2: { fr: "Sur plus de 7 000 assets, mon rôle consiste principalement à coordonner. J’en produis aussi une partie, puis je les valide et les diffuse. J’ai également structuré les méthodes de travail pour rendre l’enrichissement et la validation plus simples à l’échelle du catalogue.", en: "Across more than 7,000 assets, my role is primarily to coordinate. I also produce some of the content myself, then approve and distribute it. I have also structured working methods that make enrichment and approval easier across the catalogue." },
        cv_work1_pr1: { fr: "500 → 5 000 fiches enrichies", en: "500 → 5,000 enriched product records" },
        cv_work1_pr2: { fr: "+180 % de trafic organique sur lindt.fr, de fin 2023 à mi-2026", en: "+180% organic traffic on lindt.fr, from late 2023 to mid-2026" },
        cv_work1_pr3: { fr: "7 000+ assets coordonnés", en: "7,000+ assets coordinated" },
        cv_work1_pr4: { fr: "Salsify · Magento · Amazon · e-retail", en: "Salsify · Magento · Amazon · e-retail" },
        cv_work1_pr5: { fr: "Shootings · direction artistique", en: "Photoshoots · art direction" },
        cv_work1_note: { fr: "Je présente ici les grandes lignes. Je partage volontiers des exemples plus précis en entretien.", en: "I share the broader picture here and would be happy to discuss more specific examples in an interview." },
        cv_work1_cta: { fr: "En parler ensemble", en: "Let’s talk about it" },
        cv_work1_alt: { fr: "Sélection de contenus e-commerce et de photographies produits réalisés ou coordonnés pour Lindt", en: "A selection of e-commerce content and product photography produced or coordinated for Lindt" },
        cv_work2_label: { fr: "ArdaCraft · projet communautaire", en: "ArdaCraft · community project" },
        cv_work2_title: { fr: "Construire et faire grandir un écosystème digital", en: "Building and growing a digital ecosystem" },
        cv_work2_p1: { fr: "ArdaCraft est le projet où j’expérimente le plus. J’y ai mené la refonte du site, conçu une carte interactive à partir d’une opportunité SEO et développé une nouvelle approche des formats vidéo.", en: "ArdaCraft is where I test and build new ideas. I led the website redesign, designed an interactive map around an SEO opportunity and developed a new approach to short-form video." },
        cv_work2_p2: { fr: "Ces chantiers partent de problèmes différents, mais suivent la même logique : observer ce qui fonctionne ailleurs, l’adapter au contexte d’ArdaCraft, puis mesurer ce qui change réellement.", en: "These projects started with different problems but followed the same process: observe what already works elsewhere, adapt it to ArdaCraft, then measure the real impact." },
        cv_work2_g1: { fr: "Plateforme", en: "Platform" },
        cv_work2_g1a: { fr: "Coûts d’hébergement divisés par 10", en: "Hosting costs divided by 10" },
        cv_work2_g1b: { fr: "Usage des filtres multiplié par 6,5", en: "Filter usage multiplied by 6.5" },
        cv_work2_g2: { fr: "SEO et carte", en: "SEO and interactive map" },
        cv_work2_g2a: { fr: "Plus d’un million de recherches annuelles identifiées comme opportunité de marché", en: "More than one million annual searches identified as a market opportunity" },
        cv_work2_g2b: { fr: "50 % du trafic hors marque désormais généré par la carte", en: "The map now generates 50% of non-branded traffic" },
        cv_work2_g3: { fr: "Social", en: "Social" },
        cv_work2_g3a: { fr: "27,3 millions de vues sur 24 vidéos", en: "27.3 million views across 24 videos" },
        cv_work2_g3b: { fr: "22 vidéos sur 24 au-dessus de l’ancienne moyenne", en: "22 videos out of 24 exceeded the previous average" },
        cv_work2_cta: { fr: "Découvrir les expérimentations", en: "Explore the experiments" },
        cv_work2_alt: { fr: "Aperçus du site, de la carte interactive et de la croissance sociale d’ArdaCraft", en: "Previews of the ArdaCraft website, interactive map and social growth" },
        cv_work3_label: { fr: "Émeraude Aventure · mission indépendante · Google Ads", en: "Emeraude Aventure · independent project · Google Ads" },
        cv_work3_title: { fr: "Transformer un budget média en réservations directes", en: "Turning media spend into direct bookings" },
        ...
        cv_work3_pr1: { fr: "500+ réservations attribuées", en: "500+ attributed bookings" },
        cv_work3_pr2: { fr: "1,99 € par réservation", en: "€1.99 per booking" },
        cv_work3_pr3: { fr: "Résultats obtenus en deux mois", en: "Results achieved in two months" },
        cv_work3_pr4: { fr: "Google Ads", en: "Google Ads" },
        cv_sec_career: { fr: "Mon parcours, en bref", en: "My career, at a glance" },
        cv_tl_exp: { fr: "Expérience", en: "Experience" },
        cv_tl_now: { fr: "2023 – août 2026", en: "2023 – August 2026" },
        ...
        cv_tl2: { fr: "Consulting et projets indépendants · multi-secteurs", en: "Consulting and independent projects · multiple industries" },
        ...
        cv_tl4: { fr: "Assistant SEO Manager · Nutri & Co, Aix-en-Provence", en: "Assistant SEO Manager · Nutri & Co, Aix-en-Provence" },
        cv_tl5: { fr: "Assistant Marketing Opérationnel · EXKI, Bruxelles", en: "Operational Marketing Assistant · EXKI, Brussels" },
        cv_tl_edu: { fr: "Formation", en: "Education" },
        ...
        cv_tl_lang: { fr: "Langues", en: "Languages" },
        cv_tl_lang_fr_label: { fr: "Français", en: "French" },
        cv_tl_lang_fr: { fr: "Langue natale", en: "Native" },
        cv_tl_lang_en_label: { fr: "Anglais", en: "English" },
        cv_tl8: { fr: "Courant, C1, TOEIC 940 · présentations et réunions en contexte international", en: "Fluent, C1, TOEIC 940 · presentations and meetings in international settings" },
        cv_sec_skills: { fr: "Ce que je peux apporter", en: "What I can bring" },
        cv_sec_skills_intro: { fr: "J’aime travailler à la rencontre de plusieurs disciplines : assez près du business pour comprendre le besoin, et assez près de l’exécution pour transformer les idées en résultats concrets.", en: "I enjoy working where several disciplines meet: close enough to the business to understand the need, and close enough to delivery to turn ideas into practical results." },
        cv_skill1_t: { fr: "E-commerce et donnée produit", en: "E-commerce and product data" },
        cv_skill1_d: { fr: "Structurer un catalogue, définir les attributs, enrichir les fiches et organiser leur diffusion sur les différents canaux.", en: "Structure catalogues, define attributes, enrich product records and organise their distribution across channels." },
        cv_skill2_t: { fr: "Acquisition et SEO", en: "Acquisition and SEO" },
        cv_skill2_d: { fr: "Identifier les opportunités, améliorer l’architecture et la visibilité, puis suivre ce qui génère réellement du trafic ou des conversions.", en: "Identify opportunities, improve architecture and visibility, then track what actually generates traffic or conversions." },
        cv_skill3_t: { fr: "Contenu et direction artistique", en: "Content and art direction" },
        cv_skill3_d: { fr: "Concevoir les contenus, préparer et piloter les shootings, briefer les prestataires et garantir la cohérence jusqu’à la livraison.", en: "Design content, prepare and lead photoshoots, brief partners and maintain consistency through to final delivery." },
        cv_skill4_t: { fr: "Produit digital et analytics", en: "Digital products and analytics" },
        cv_skill4_d: { fr: "Concevoir des parcours et des interfaces, lire les usages, construire les tableaux de bord utiles et améliorer l’expérience à partir des données.", en: "Design journeys and interfaces, analyse user behaviour, build useful dashboards and improve the experience through data." },
        cv_tools_label: { fr: "La boîte à outils, au quotidien", en: "My day-to-day toolkit" },
        cv_tools_g1: { fr: "Web et e-commerce", en: "Web & e-commerce" },
        cv_tools_g2: { fr: "Data, acquisition et SEO", en: "Data, acquisition & SEO" },
        cv_tools_g3: { fr: "IA générative", en: "Generative AI" },
        cv_tools_g4: { fr: "Création", en: "Creative" },
        cv_tools_g5: { fr: "Bureautique et projets", en: "Productivity & project management" },
        cv_sec_quotes: { fr: "Ce qu’en disent mes collègues et clients", en: "What colleagues and clients say" },
        cv_quote_translated: { fr: "Traduit du français", en: "Translated from French" },
        cv_quote1_role: { fr: "Senior Digital E-commerce Manager · Lindt & Sprüngli", en: "Senior Digital E-commerce Manager · Lindt & Sprüngli" },
        cv_quote2_role: { fr: "Dirigeant · Émeraude Aventure", en: "Director · Emeraude Aventure" },
        cv_quote3_role: { fr: "Senior Communication Manager · Lindt & Sprüngli", en: "Senior Communication Manager · Lindt & Sprüngli" },
        cv_quote4_role: { fr: "Senior Digital Manager · Lindt France", en: "Senior Digital Manager · Lindt France" },
        // La relation de travail, en tête de chaque attribution.
        cv_quote1_rel: { fr: "Collègue dans mon équipe", en: "Colleague on my team" },
        cv_quote2_rel: { fr: "Client", en: "Client" },
        cv_quote3_rel: { fr: "Collègue d’une autre équipe", en: "Colleague from another team" },
        cv_quote4_rel: { fr: "Ma manager", en: "My manager" },
        ...
        cv_perso1_d: { fr: "Je pratique la photographie depuis plusieurs années. C’est aussi de là que viennent mon goût pour la direction artistique, mon attention aux détails et mon intérêt pour l’image produit.", en: "I have been practising photography for several years. It is also where my interest in art direction, attention to detail and product imagery comes from." },
        cv_perso2_t: { fr: "Endurance", en: "Endurance" },
        cv_perso2_d: { fr: "Marathons, trails, Ironman 70.3 : j’aime les objectifs ambitieux qui se gagnent moins sur un coup d’éclat que par la régularité.", en: "Marathons, trail races and an Ironman 70.3: I enjoy ambitious goals that are achieved through consistency rather than a single burst of effort." },
        cv_sec_search: { fr: "Ce que je recherche aujourd’hui", en: "What I am looking for now" },
        cv_sec_search_intro: { fr: "Je cherche un rôle où je pourrai prendre de la hauteur sans perdre le contact avec l’exécution : structurer, coordonner et faire progresser des projets digitaux concrets.", en: "I am looking for a role where I can take a broader view without losing touch with delivery: structuring, coordinating and moving practical digital projects forward." },
        cv_spec1_t: { fr: "Contrat", en: "Contract" },
        cv_spec1_v: { fr: "CDI", en: "Full-time permanent position" },
        cv_spec2_t: { fr: "Rôle", en: "Role" },
        cv_spec2_v: { fr: "E-commerce / marketing digital", en: "E-commerce / digital marketing" },
        cv_spec3_t: { fr: "Mobilité", en: "Mobility" },
        cv_spec3_v: { fr: "France, Belgique, Suisse, Luxembourg · sur site ou remote", en: "France, Belgium, Switzerland or Luxembourg · on-site or remote" },
        ...
        cv_case4_title: { fr: "De Webflow à une architecture décentralisée", en: "From Webflow to a decentralized architecture" },
        cv_case4_desc: { fr: "Migration de plateforme, des centaines de pages dynamiques en headless, coûts d'hébergement divisés par dix. L'usage des filtres a été multiplié par 6,5 après lecture des données Clarity.", en: "Platform migration, hundreds of dynamic pages headless, hosting costs cut by ten. Filter usage multiplied by 6.5 after reading the Clarity data." },
        ...
        cv_tag_arda: { fr: "ArdaCraft · projet communautaire", en: "ArdaCraft · community project" },
        cv_case5_title: { fr: "27,3 millions de vues sur 24 vidéos", en: "27.3 million views on 24 videos" },
        cv_case5_desc: { fr: "Emprunter le format d’une niche voisine plutôt qu’en inventer un. Production vidéo, montage, croissance d’audience.", en: "Borrowing a neighbouring niche’s format instead of inventing one. Video production, editing, audience growth." },
        cv_case5_alt: { fr: "Croissance des abonnés Instagram d’ArdaCraft", en: "ArdaCraft Instagram follower growth" },
        ...
        cv_skill1_d: { fr: "Audit technique, arborescence, netlinking, suivi de positions.", en: "Technical audits, site structure, link building, rank tracking." },
        cv_skill2_t: { fr: "Data & analytics", en: "Data & analytics" },
        cv_skill2_d: { fr: "Tableaux de bord, suivi de KPI, lecture des parcours utilisateurs.", en: "Dashboards, KPI tracking, reading user journeys." },
        cv_skill3_t: { fr: "Contenu & direction artistique", en: "Content & art direction" },
        cv_skill3_d: { fr: "Shootings, 3D, brief prestataires, validation.", en: "Photo shoots, 3D, briefing providers, sign-off." },
        cv_skill4_t: { fr: "E-commerce & PIM", en: "E-commerce & PIM" },
        cv_skill4_d: { fr: "Modèle de donnée produit, attributs, enrichissement, mise en ligne.", en: "Product data model, attributes, enrichment, publishing." },
        cv_skill5_t: { fr: "Design & intégration", en: "Design & build" },
        cv_skill5_d: { fr: "Maquettes, intégration HTML/CSS/JS, headless.", en: "Mockups, HTML/CSS/JS build, headless." },
        cv_skill6_t: { fr: "Social & communauté", en: "Social & community" },
        cv_skill6_d: { fr: "Production vidéo, formats courts, croissance d'audience.", en: "Video production, short form, audience growth." },
        ...
        cv_tl7: { fr: 'DUETI Business · University of the West of Scotland', en: 'DUETI Business · University of the West of Scotland' },
        cv_tl_lang_fr_label: { fr: 'français', en: 'French' },
        cv_tl_lang_fr: { fr: 'Langue natale.', en: 'Native language.' },
        cv_tl_lang_en_label: { fr: 'anglais', en: 'English' },
        cv_tl8: { fr: 'Courant, C1 (TOEIC 940). Présentations et réunions en contexte international.', en: 'Fluent, C1 (TOEIC 940). Presentations and meetings in international settings.' },
        ...
        fond_1: { fr: "Je suis <strong>Pierre</strong>, <strong>responsable marketing digital</strong>&nbsp;: j'optimise les <strong>ventes e-commerce</strong> en combinant <strong>contenu, data produit, acquisition et UX</strong>, et je recherche un <strong>CDI dès septembre 2026</strong> sur site ou en remote (France, Belgique, Suisse, Luxembourg).", en: "I'm <strong>Pierre</strong>, a <strong>digital marketing manager</strong>: I grow <strong>e-commerce sales</strong> by combining <strong>content, product data, acquisition and UX</strong>, and I am looking for a <strong>permanent role from September 2026</strong>, on site or remote (France, Belgium, Switzerland, Luxembourg)." },
        ...
        fond_19: { fr: "Lindt & Sprüngli · CDI · 2023 – août 2026", en: "Lindt & Sprüngli · full-time role · 2023 – August 2026" },
        fond_20: { fr: "ArdaCraft · projet communautaire", en: "ArdaCraft · community project" },
        fond_21: { fr: "Émeraude Aventure · mission indépendante · Google Ads", en: "Emeraude Aventure · independent project · Google Ads" },
