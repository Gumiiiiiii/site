(function () {
    const DICT = {
        ...
        bg_s6_h1_texte: { fr: "Le tracé lui-même est tramé, pas une plaque derrière. Le dessin sert de masque, la trame le remplit, et le trait épaissit à 3,4 unités pour qu'un point tienne trois fois dans sa largeur. À réserver aux grands formats, à partir de 72 px.", en: "The stroke itself is screened, not a plate behind it. The drawing serves as a mask, the screen fills it, and the stroke thickens to 3.4 units so a dot fits across it three times. Keep it for large formats, from 72px up." },
