(function () {
    const DICT = {
        ...
        bg_s1_intro: { fr: "Mon ton est celui d'un expert technique pragmatique. Je suis direct, créatif, et je vais à l'essentiel sans utiliser de jargon superflu.", en: "My tone is that of a pragmatic technical expert. Direct, creative, straight to the point, without needless jargon." },
        ...
        bg_s2_intro: { fr: "Le fond de chaque page est une feuille de papier pointé, celle des carnets sur lesquels je dessine et je planifie mes projets. Ce n'est pas une texture posée derrière le contenu : les titres s'écrivent sur ses rangées, et les blocs se calent sur ses colonnes.", en: "Every page sits on a sheet of dot-grid paper, the notebooks I sketch and plan my projects on. It is not a texture dropped behind the content: headings are written on its rows, and blocks line up on its columns." },
        bg_s2_h1: { fr: "Une seule trame", en: "One single screen" },
        bg_s2_h1_texte: { fr: "Le champ entier est un halftone d'imprimeur. Le haut et le bas de page portent une trame pleine de points gras qui rétrécissent vers le centre ; ceux qui restent forment la grille du milieu, tous du même calibre. Le dégradé et la grille sont un seul dessin pris à deux moments, et l'encre ne varie jamais : c'est la taille des points qui porte le ton.", en: "The whole field is a printer’s halftone. The top and bottom of the page carry a full screen of heavy dots that shrink towards the centre; the ones left standing form the middle grid, all the same size. The gradient and the grid are one drawing caught at two moments, and the ink never varies: dot size carries the tone." },
        ...
        bg_s2_h2_texte: { fr: "Chaque titre de section est écrit sur une rangée de la grille, et cette rangée-là est retracée par-dessus le champ à une encre de 0,18. Elle s'éteint vers les bords de l'écran sans jamais descendre sous 46 % de sa valeur. Les titres de cette page en sont la démonstration : regardez la ligne qui passe derrière chacun d'eux.", en: "Every section heading is written on a row of the grid, and that row is redrawn over the field at 0.18 ink. It fades towards the edges of the screen without ever dropping below 46% of its value. The headings on this page are the demonstration: look at the line running behind each one." },
        bg_s2_h4: { fr: "Rien ne laisse voir la trame au travers", en: "Nothing lets the screen show through" },
        bg_s2_h4_texte: { fr: "Une carte, un bloc, un champ de saisie : tout ce qui se pose sur le papier prend le fond du papier, en opaque. Deux trames superposées ne se lisent plus, et un texte qui a des points derrière lui perd son contraste. Le voile d'encre d'un bloc se peint donc par-dessus un fond plein, jamais à la place.", en: "A card, a block, an input field: everything set on the paper takes the paper's background, opaque. Two overlaid screens stop being readable, and text with dots behind it loses its contrast. A block's ink veil is therefore painted over a solid background, never instead of one." },
        bg_s3_titre: { fr: "Couleurs", en: "Colours" },
        bg_s3_intro: { fr: "Une encre, un papier. Toute la hiérarchie se fait à l'opacité de l'encre, jamais en changeant de teinte. Le violet est réservé aux états interactifs : survol, focus clavier, élément courant. Une couleur qui apparaît sans qu'on ait rien fait n'a rien à dire.", en: "One ink, one paper. The whole hierarchy is built from ink opacity, never from a change of hue. Purple is reserved for interactive states: hover, keyboard focus, current item. A colour that shows up without anyone doing anything has nothing to say." },
        ...
        bg_s4_intro: { fr: "Deux familles, deux rôles qui ne se croisent jamais. Urbanist porte tout ce qui est imprimé sur la page. Cedarville Cursive porte tout ce qui est écrit à la main par-dessus.", en: "Two families, two roles that never cross. Urbanist carries everything printed on the page. Cedarville Cursive carries everything handwritten over it." },
        ...
        bg_s4_h4: { fr: "Les titres ne portent aucune ponctuation", en: "Headings carry no punctuation" },
        bg_s4_h4_texte: { fr: "Un titre s'arrête sur son dernier mot. Le point qui suivait les H1 a été retiré de la direction : il ajoutait une couleur là où rien ne se passait, et rendait les titres plus bavards qu'ils ne devaient l'être. Le point du logotype, lui, appartient au logo et ne se rejoue nulle part ailleurs.", en: "A heading stops on its last word. The full stop that used to follow the H1 has been taken out of the direction: it added colour where nothing was happening, and made headings more talkative than they needed to be. The logotype's dot belongs to the logo and is never replayed anywhere else." },
        bg_s5_titre: { fr: "Annotations", en: "Annotations" },
        bg_s5_intro: { fr: "Les notes manuscrites sont ce que j'ajoute dans la marge d'un carnet après coup. Elles se posent par-dessus la page, en position absolue, hors du flux et hors de l'arbre d'accessibilité. Retirez le bloc entier et la mise en page reste exactement la même. Chaque traitement est montré ici centré dans sa fiche, pour qu'on puisse les comparer ; en service, ce sont les décalages du tableau plus bas qui les collent à l'élément qu'elles annotent.", en: "Handwritten notes are what I add in a notebook margin after the fact. They sit over the page, absolutely positioned, out of the flow and out of the accessibility tree. Remove the whole block and the layout stays exactly the same. Each treatment is shown here centred in its card so they can be compared; in service, it is the offsets in the table below that pin them against the element they annotate." },
        ...
        bg_s5_r6_t: { fr: "Dosage", en: "Dosage" },
        bg_s5_r6: { fr: "Une par bloc au maximum. Au-delà, la page ne ressemble plus à un carnet annoté mais à un mur de post-its.", en: "One per block at most. Past that, the page stops looking like an annotated notebook and starts looking like a wall of sticky notes." },
        bg_s6_titre: { fr: "Icônes", en: "Icons" },
        bg_s6_intro: { fr: "La bibliothèque Lucide, en trait de 2,5 px, avec les extrémités et les angles arrondis. Géométriques et lisibles à petite taille, elles servent l'interface, la manipulation de fichiers et le code.", en: "The Lucide library, at 2.5px stroke, with rounded caps and joins. Geometric and legible at small sizes, they serve the interface, file handling and code." },
        bg_s6_h1: { fr: "L'icône en halftone", en: "The halftone icon" },
        bg_s6_h1_texte: { fr: "C'est le tracé de l'icône lui-même qui est tramé. Le dessin sert de masque, et la trame de points le remplit : l'aire du point suit le ton, comme sur le fond de la page, et les points se resserrent au centre du dessin. Le trait épaissit à 3,4 unités pour qu'un point tienne trois fois dans sa largeur, sans quoi la trame ne se lirait pas. Réservez ce traitement aux têtes de section et aux grands formats, à partir de 72 px ; en dessous, la trame se referme et l'icône redevient un aplat.", en: "It is the icon's own stroke that is screened, not a plate laid behind it. The drawing serves as a mask and the dot screen fills it: dot area follows the tone, as on the page background, and the dots tighten towards the centre of the drawing. The stroke thickens to 3.4 units so a dot fits across it three times, without which the screen would not read. Keep this treatment for section heads and large formats, from 72px up; below that the screen closes and the icon becomes a flat shape again." },
        bg_s7_titre: { fr: "Mouvement", en: "Motion" },
        bg_s7_intro: { fr: "Ce qui n'a pas encore été atteint est transparent et posé un cheveu plus bas. Quand son tour vient, on lui retire ce retard, en décalant ses voisins d'un souffle. Rien n'est caché tant que le script en tête de document n'a pas posé sa classe sur la racine, et il ne la pose ni sans JavaScript, ni quand le système demande moins de mouvement.", en: "Anything not yet reached is transparent and sits a hair lower. When its turn comes that delay is taken away, offsetting its neighbours by a breath. Nothing is hidden until the script at the top of the document puts its class on the root, and it does so neither without JavaScript nor when the system asks for reduced motion." },
        ...
        bg_s8_intro: { fr: "Le neumorphisme a été retiré. Un relief simulé suppose une lumière et une matière molle, et ni l'un ni l'autre n'existe sur une feuille de papier. Un composant est donc une forme pleine, un contour, ou rien du tout. L'état se dit par la couleur de la bordure et du texte.", en: "Neumorphism has been removed. A simulated relief assumes a light source and a soft material, and neither exists on a sheet of paper. A component is therefore a solid shape, an outline, or nothing at all. State is carried by the colour of the border and the text." },
        ...
        bg_s9_intro: { fr: "Des photographies brutes, cadrées serré, sans filtre de couleur. Elles sont posées dans des cadres au même rayon que les blocs, avec le même filet, pour qu'elles appartiennent à la page plutôt que d'y flotter.", en: "Raw photographs, tightly framed, with no colour filter. They sit in frames with the same radius as the blocks and the same rule, so they belong to the page rather than float on it." },
        bg_s10_titre: { fr: "Applications", en: "Applications" },
        bg_s10_intro: { fr: "Le système appliqué hors du site. Chaque rendu ci-dessous est composé en direct avec la trame, les fontes et l'échelle d'encre de la page, aux dimensions exactes attendues par la plateforme. Ce sont des maquettes à recomposer dans un outil de design, pas des fichiers exportables.", en: "The system applied off the site. Each rendering below is composed live with the page's own screen, typefaces and ink scale, at the exact dimensions the platform expects. They are mockups to rebuild in a design tool, not exportable files." },
        ...
        bg_app_r4_t: { fr: "La marge", en: "The margin" },
        bg_app_r4: { fr: "8 % de la largeur du visuel, la même que celle des sections du site.", en: "8% of the visual's width, the same as the site's sections." },
