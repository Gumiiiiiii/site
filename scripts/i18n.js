(function () {
    const DICT = {
        ...
        bg_s6_intro: { fr: "Dix icônes semées de points. Le tracé Lucide sert de chemin, et on y pose des points tous du même calibre, à intervalle régulier. C’est la même matière que le fond de la page, à l’échelle d’une icône.", en: "Ten icons sown with dots. The Lucide stroke serves as the path, and dots of a single size are placed along it at regular intervals. The same material as the page background, at the scale of an icon." },
        bg_s6_h1: { fr: "À la taille de la page", en: "At page size" },
        bg_s6_h1_texte: { fr: "26 px, la taille d’une icône dans une carte ou un bouton. Les points restent des points : ils sont en SVG, donc ni la trame ni le trait ne se dégradent en descendant.", en: "26px, the size of an icon in a card or a button. The dots stay dots: they are SVG, so neither the screen nor the stroke degrades on the way down." },
        bg_s6_h2: { fr: "La règle du semis", en: "The sowing rule" },
        bg_s6_h2_texte: { fr: "Un point tous les 3 unités le long du chemin, sur la grille de 24 du dessin, et un rayon de 1 unité pour tous. Les extrémités portent toujours un point, et là où deux formes se rejoignent, le doublon est retiré sous un demi-pas. De 12 à 34 points par icône.", en: "One dot every 3 units along the path, on the drawing's 24 grid, and a radius of 1 unit for all of them. Endpoints always carry a dot, and where two shapes meet the duplicate is dropped below half a pitch. From 12 to 34 dots per icon." },
