(function () {
    const DICT = {
        ...
        fond_1: { fr: "Je m'appelle <strong>Pierre</strong>, <strong>responsable marketing digital</strong>&nbsp;: j'optimise les <strong>ventes e-commerce</strong> en combinant <strong>contenu, data produit, acquisition et UX</strong>, et je recherche un <strong>CDI dès maintenant</strong> sur site ou en remote (France, Belgique, Suisse, Luxembourg, Irlande).", en: "My name is <strong>Pierre</strong>, <strong>digital marketing manager</strong>: I grow <strong>e-commerce sales</strong> by combining <strong>content, product data, acquisition and UX</strong>, and I am looking for a <strong>permanent role starting immediately</strong>, on site or remote (France, Belgium, Switzerland, Luxembourg, Ireland)." },
        ...
        fond_35: { fr: "8 000 → 115 000 abonnés sur Instagram", en: "8,000 → 115,000 followers on Instagram" },
        fond_36: { fr: "27,3 millions de vues sur 24 vidéos, sur Instagram", en: "27.3 million views across 24 videos, on Instagram" },
        fond_37: { fr: "500+ réservations attribuées", en: "500+ attributed bookings" },
        fond_38: { fr: "1,67 € par conversion", en: "€1.67 per conversion" },
        ...
        fond_93: { fr: "Immédiate", en: "Immediate" },
        ...
        fond_117: { fr: "Irlande", en: "Ireland" },
