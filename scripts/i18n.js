(function () {
    const DICT = {
        ...
        bg_s6_intro: { fr: "Dix icônes, toutes en halftone. Le trait Lucide ne sert plus que de dessin de départ : c’est le tracé tramé qui est posé sur la page. Les fichiers sont noirs sur transparent et servent de masque, donc ils prennent l’encre de la page dans les deux thèmes.", en: "Ten icons, all halftone. The Lucide stroke is now only the starting drawing: what goes on the page is the screened version. The files are black on transparent and serve as a mask, so they take the page's ink in both themes." },
        bg_s6_h1: { fr: "À la taille de la page", en: "At page size" },
        bg_s6_h1_texte: { fr: "26 px, la taille d’une icône dans une carte ou un bouton. À cette échelle la trame de 9,5 px tombe à 0,6 px : elle ne se voit plus, et l’icône se lit comme un aplat légèrement rongé sur les bords.", en: "26px, the size of an icon in a card or a button. At that scale the 9.5px screen drops to 0.6px: it no longer shows, and the icon reads as a flat shape slightly eaten at the edges." },
        bg_s6_h2: { fr: "Où la trame se referme", en: "Where the screen closes up" },
        bg_s6_h2_texte: { fr: "La même icône à quatre tailles. La trame ne redevient lisible qu’à partir de 200 px de côté, quand son pas repasse au-dessus de 5 px à l’écran. En dessous, le halftone est une matière qu’on paie sans la voir.", en: "The same icon at four sizes. The screen only becomes legible from 200px across, when its pitch climbs back above 5px on screen. Below that, the halftone is a material you pay for without seeing it." },
        ...
        bg_res7_t: { fr: "Les dix icônes en halftone", en: "The ten halftone icons" },
        bg_res7_d: { fr: "PNG de 400 × 400, noirs sur fond transparent. À poser en masque pour qu’ils prennent la couleur du support, ou tels quels sur un fond clair.", en: "400 × 400 PNGs, black on a transparent background. Use them as a mask so they take the colour of whatever carries them, or as they are on a light background." },
        bg_dl_icone: { fr: "Exemple PNG", en: "Sample PNG" },
