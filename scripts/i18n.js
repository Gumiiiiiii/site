(function () {
    const DICT = {
        ...
        cv_case1_tag: { fr: "Lindt & Sprüngli · CDI · 2023, août 2026", en: "Lindt & Sprüngli · full-time · 2023 to Aug 2026" },
        cv_case1_title: { fr: "Piloter le contenu e-commerce d'une marque internationale", en: "Running e-commerce content for an international brand" },
        cv_case1_desc: { fr: "Modèle de donnée produit, enrichissement, mise en ligne, direction artistique, shootings photo, 3D, SEO.", en: "Product data model, enrichment, publishing, art direction, photo shoots, 3D, SEO." },
        ...
        cv_case2_title: { fr: "La carte interactive et le million de recherches", en: "The interactive map and the million searches" },
        cv_case2_desc: { fr: "Analyse de marché, lecture des SERP, conception produit, acquisition organique.", en: "Market analysis, SERP reading, product design, organic acquisition." },
        ...
        cv_skill2_d: { fr: "GA4, Looker Studio, Clarity.", en: "GA4, Looker Studio, Clarity." },
        ...
        cv_skill4_d: { fr: "Magento, Salsify. Modèle de donnée, attributs, enrichissement, mise en ligne.", en: "Magento, Salsify. Data model, attributes, enrichment, publishing." },
        cv_skill5_t: { fr: "Design & intégration", en: "Design & build" },
        cv_skill5_d: { fr: "Figma, Webflow, HTML/CSS/JS, headless.", en: "Figma, Webflow, HTML/CSS/JS, headless." },
        ...
        cv_tools_g1: { fr: "E-commerce & PIM", en: "E-commerce & PIM" },
        cv_tools_g2: { fr: "Data & SEO", en: "Data & SEO" },
        cv_tools_g3: { fr: "Design & web", en: "Design & web" },
